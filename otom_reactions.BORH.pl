...
# output table
open TABLE,   ">otoms.reactions_table.BORH.txt" || die "error opening output table file";
open LIST_OUT,">otoms.reactions_list.BORH.txt"  || die "error opening output list file";
open DECAY_OUT,">otoms.decay_reactions_list.BORH.txt"  || die "error opening output list file";
