...
syntax match Decay_type_stable     /\<55\s\+25\s\+Nb\>/ | syntax match Decay_type_stable     /\<Nb-55\>/
...
let decaydict["55 25 Nb"]= decay_text_stable     | let decaydict["Nb-55"]= decay_text_stable
