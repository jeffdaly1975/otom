...
#      326 isotopes
#   106276 combinations
#    53301 unique combinations
#    14076 combinations resulting in known isotopes
...
# output table
open TABLE,   ">otoms.reactions_table.ALPHA.txt" || die "error opening output table file";
open LIST_OUT,">otoms.reactions_list.ALPHA.txt"  || die "error opening output list file";
open DECAY_OUT,">otoms.decay_reactions_list.ALPHA.txt"  || die "error opening output list file";
